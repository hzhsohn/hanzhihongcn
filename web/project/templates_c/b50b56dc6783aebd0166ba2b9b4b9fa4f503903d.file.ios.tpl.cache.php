<?php /* Smarty version Smarty-3.1.16, created on 2017-09-23 01:15:14
         compiled from "./templates/ios.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_59c52c068aa237_31810576',
  'variables' => 
  array (
    'APP' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_59c52c068aa237_31810576')) {function content_59c52c068aa237_31810576($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
?>
  <div class="raised"> <b class="b1"></b><b class="b2"></b><b class="b3"></b><b class="b4"></b>
    <h4><img src="ios/apple.png"/><?php echo $_smarty_tpl->tpl_vars['APP']->value[$_smarty_tpl->getVariable('smarty')->value['section']['outer']['index']]['appname'];?>
</h4>
...
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['APP']->value[$_smarty_tpl->getVariable('smarty')->value['section']['outer']['index']]['video'];?>
            ...
            <p><strong>下载地址</strong></p><?php if ($_smarty_tpl->tpl_vars['APP']->value[$_smarty_tpl->getVariable('smarty')->value['section']['outer']['index']]['appstore']) {?><p><a href="<?php echo $_smarty_tpl->tpl_vars['APP']->value[$_smarty_tpl->getVariable('smarty')->value['section']['outer']['index']]['appstore'];?>
" target="_blank">----AppStore-----</a></p><?php } else { ?><p>已下架</p><?php }?>
            </td>
        </tr>
      </table>
    </div>
