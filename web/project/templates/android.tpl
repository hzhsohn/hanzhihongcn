...
<div id="divContent" >
  ...
  <div class="raised"> <b class="b1"></b><b class="b2"></b><b class="b3"></b><b class="b4"></b>
    <h4><img src="android/android_root.png"/>{$APP[outer].appname}</h4>
      ...
      <table border="0" cellpadding="0" cellspacing="0" >
        <tr>
          ...
          <td valign="top" ><p><strong>内容提要</strong></p><p>{$APP[outer].content} <br /></p>
            ...
            <p><strong>下载地址</strong></p>{if $APP[outer].apk}<p><a href="{$APP[outer].apk}" target="_blank">----APK-----</a></p>{else}<p>已下架</p>{/if}
            </td>
        </tr>
      </table>
    </div>
