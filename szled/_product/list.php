...
if(0==strcmp($method,'delete'))
{
	...
	$sql='delete from tbProduct where autoid='.$autoid;
...
$db->query('select *from tbProduct order by uptime'.$orderby,$showcount,$page);
?>
...
if($showcount>0)
{
	$db->query('select count(*) from tbProduct',0,0);
	$rsct=$db->read();
	$n=$rsct[0]/$showcount;
