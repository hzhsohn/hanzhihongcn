...
* @example
      $mail = new PzhMail();
      $mail->setServer("smtp.163.com", "sohn@163.com", "asdffdsa",465,true,true); //设置smtp服务器，到服务器的SSL连接
      $mail->setFrom("sohn@163.com"); //设置发件人
      $mail->setReceiver("hzh.888@qq.com"); //设置收件人，多个收件人，调用多次
